        ...
        <div className="about-sections">
            ...
            <div className="about-right">
                <div className="about-para">
                    ...
                    <p>With experience in full-stack development, I’ve contributed to projects ranging from AI-driven solutions to real-time web applications. I’ve developed systems like Farmfleet (farm management system), MediDocs (automated patient documentation), and a chat app for Souloxy. Currently, I’m working on an AI-powered Random Question Paper Generator and exploring Langchain, TensorFlow, and LLMs.</p>
